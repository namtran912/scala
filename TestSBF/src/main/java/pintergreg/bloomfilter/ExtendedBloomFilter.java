...
public class ExtendedBloomFilter extends BloomFilter implements Serializable{
    ...
    public boolean include(int[] indexes) {
        ...
        //System.out.print("include extend:");
        for (int i : indexes) {
            //System.out.print(super.bitSet.get(i) + " ");
    ...
    public int count(int[] indexes) {
        int result = Integer.MAX_VALUE;

        //System.out.print("count extend:");
        for (int i : indexes) {
            result = Math.min(result, super.cbitSet[i]);
            //System.out.print(super.cbitSet[i] + " ");
        }
        //System.out.println();
        return result;
    }
